    ...
    <>
      <SectionAbout
        ...
        desc="Assist ecologists in preserving and promoting the conservation of animal species by supporting their efforts to protect natural habitats, 
          ...
          and promote the health of ecosystems that are vital for the planet. " pic={pic1} info="be the change you want to see" />
      ...
      " pic={pic2} info="power on the tip of your fingers" />
      ...
      Additionally, you have the option to download the data for your own use." pic={pic3} info="data to power research" />
